    ...
    <v-container grid-list-lg>
        ...
        <v-layout row wrap>
            <v-flex xs12 sm12 md3>
                <v-card>
                    <v-img src="http://source.unsplash.com/hjCA3ecCXAQ" height="200px">
            ...
            <v-flex xs12 sm12 md3>
                <v-card>
                    <v-img src="http://source.unsplash.com/6S27S6pZ6o0" height="200px">
                        <v-container fill-height fluid>
                            <v-layout fill-height>
                                <v-flex xs12 align-end flexbox>
            ...
            <v-flex xs12 sm12 md3>
                <v-card>
                    <v-img src="http://source.unsplash.com/1SPu0KT-Ejg" height="200px">
                        <v-container fill-height fluid>
                            <v-layout fill-height>
                                <v-flex xs12 align-end flexbox>
